...
มีสองวิธีลดความเสี่ยงโดยยังอยู่ทางนี้:

1. **Branch protection** ([บทที่ 7](/docs/branch-protection)) บังคับว่าต้องผ่าน CI ก่อน
   merge เข้า main ได้ — ทางนี้แก้ได้เกือบหมด เพราะโค้ดที่ยังไม่ผ่าน CI จะเข้า main
   ไม่ได้ตั้งแต่แรก
2. **ยอมรับความเสี่ยง** สำหรับ docs site หรือเว็บ marketing มักจะพอ
   เพราะพังแล้ว rollback ได้ในคลิกเดียว

แต่ถ้าคุณต้องการให้ **CI เป็นด่านจริง ๆ** หรือต้องมีคนกดอนุมัติก่อน deploy →
[ไปบทที่ 6](/docs/cd-actions)
